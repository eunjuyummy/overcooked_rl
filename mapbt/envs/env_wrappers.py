...
from mapbt.utils.util import tile_images
...
class ShareDummyVecEnv(ShareVecEnv):
    ...
    def step_wait(self):
        ...
        return obs, np.array(share_obs), np.array(rews), np.array(dones), infos, np.array(available_actions)
